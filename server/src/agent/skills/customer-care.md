---
name: customer-care
description: Questions about an order the customer has already placed, what the brand's policies say, delivery and returns, and complaints. Not needed for choosing a product.
---
...
- When the brand has not told Convo its policy on something, say that you do not have it and offer to pass the question on. Do not invent a policy, and do not describe what is "standard".
