...
const SCRIPT: Array<{ frame: Frame; hold: number }> = [
  {
    frame: { kind: "typing", text: "i need something for a sangeet" },
    hold: 1500,
  },
  {
    frame: { kind: "sent", text: "i need something for a sangeet" },
    hold: 260,
  },
  {
    frame: { kind: "status", text: "looking through the catalogue" },
    hold: 1150,
  },
      ...
      <div className="demo-body">
        {sent && (
          <p className="demo-bubble">
            {(SCRIPT[1]!.frame as { text: string }).text}
          </p>
        )}
        ...
        {has("reply") && !status && (
          <p className="demo-reply">
            {(SCRIPT[3]!.frame as { text: string }).text}
          </p>
        )}
