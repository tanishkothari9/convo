...
export function Settings() {
  ...
  async function save(event: React.FormEvent) {
    ...
    setBusy(true);
    try {
      const result = await api.patch<{ tenant: Tenant }>(
        "/dashboard/tenant",
        form,
      );
      ...
      <form onSubmit={save}>
        <section className="panel">
          ...
          <div className="field-pair">
            ...
            <div className="field">
              ...
              <p className="field-hint">
                How your brand is named in API responses and webhooks. Changing
                it breaks anything already matching on the old value.
              </p>
            </div>
          </div>
          ...
          <div className="field">
            ...
            />
            <p className="field-hint">
              What you sell, in a line. Convo uses it to tell your goods apart
              from another brand&rsquo;s when a shopper asks something
              open-ended.
            </p>
          </div>
        </section>
          ...
          <label className="switch-row">
            ...
            <span className="switch-text">
              ...
              <span className="field-hint">
                On, an order cannot be paid for until the shopper has given a
                delivery address. Turn it off only if you sell something that
                arrives without a parcel.
              </span>
            </span>
          </label>
          ...
          <label className="switch-row">
            ...
            <span className="switch-text">
              <span className="switch-label">
                List my catalogue on the marketplace
              </span>
              <span className="field-hint">
                Your products appear alongside other brands, and shoppers pay
                you directly on your own payment account. Convo never holds the
                money. Turning this off takes your catalogue down immediately;
                nothing else changes.
              </span>
              {!form.isListed && blockers.length > 0 && (
                <span className="field-hint field-hint-blocked">
                  {blockers[0]}
                </span>
              )}
            </span>
